                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td class="logo" style="text-align: center;">
                                        <h1>${args.name ? "Hi" + " " + args.name : "SLMS"}</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td valign="middle" class="hero bg_white" style="padding: 1em 0 2em 0;">
                            <img src="https://firebasestorage.googleapis.com/v0/b/slms-dev.appspot.com/o/email.webp?alt=media&token=ba77fb8c-f77d-4c1e-b33d-f48dd9409c9a"
                                alt="" style="width: 200px; max-width: 600px; height: auto; margin: auto; display: block;">
                        </td>
                    </tr><!-- end tr -->
                    <tr>
...
const getAccountActivateTemplate = (name: string) => {
  return getTemplate({
    name,
    title: AppMessages.ACCOUNT_ACTIVATION_MAIL_TITLE,
    message: AppMessages.ACCOUNT_ACTIVATION_MAIL_MESSAGE,
    btnText: AppMessages.ACCOUNT_ACTIVATION_BTN_TEXT,
  });
};

const getAccountRegisteredTemplate = (name: string) => {
  return getTemplate({
    name,
    title: AppMessages.ACCOUNT_REGISTERED_MAIL_TITLE,
    message: AppMessages.ACCOUNT_REGISTERED_MAIL_MESSAGE,
  });
};

const getAccountCreatedTemplate = (userInfo: IUser) => {
  return getTemplate({
    name: userInfo.name,
