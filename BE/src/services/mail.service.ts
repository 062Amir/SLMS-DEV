...
import { getAccountActivateTemplate, getAccountCreatedTemplate, getAccountRegisteredTemplate } from "../templates/email.template";
...
export { sendAccountActivationMail, sendAccountRegisteredMail, sendAccountCreatedMail };
